                                ...
                                <td style="width: 120px">
                                  <table>
                                    <tr class="each-details">
                                      <td>
                                        <img
                                          src="https://ci3.googleusercontent.com/meips/ADKq_NYoZjQWGtMDY57zMIqt_xnwdDkjDeahorEgoaR26SHjYsM-SOSjFCW-qtwZWCjLoenDOVq2pLJvI0y-ykGzmOfMqYZj7OmeZRYodG9dhE7CPBP_7abJqHJgvXNQljFbbZDLywST_w=s0-d-e1-ft#https://api-analyticslabsquire-staging.up.railway.app/public/images/HomeIcon.png"
                                        />
                                      </td>
                                      <td>
                                        <p>
