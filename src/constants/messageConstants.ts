...
const TARGETS_ACHIVED_SYNCED_SUCCESS = "Targets achived synced successfully";
const TARGETS_ACHIVED_NOT_FOUND = "Targets achived data not found!";
const SALES_REP_MONTHLY_ACHIVES_SUCCESS = "Sales Reps Monthly Achives Fetched Successfully";
const SUCCESS_SYNC_SALES_REPS_MONTHLY_TARGETS = "Successfully synced sales reps targets";

const TARGETS_ACHIEVED_DATA_FETCH_SUCCESS = "SalesReps monthly targets and achieved data fetched successfully";

const SALES_REP_MONTHLY_WISE_FACILITIES_COUNT_FETCHED_SUCCESSFULLY = "SalesReps monthly facilities count fetched successfully";
const SUCCESS_FETCHED_STATS = "Stats Fetched Successfully";

const SUCCESS_SALES_REPS_SYNC = "Successfully Synced Sales Reps";

const SUCCESS_SYNCED_FACILICES = "Facilities Data Synced Successfully";
...
export {
    ...
    SALES_REPS_TARGET_DATA_SUMMARY_EMAIL_SENT_SUCCESS, EMAIL_CRON_STARTED_SUCCESS, TARGETS_ACHIVED_SYNCED_SUCCESS,
    SALES_REP_MONTHLY_ACHIVES_SUCCESS, TARGETS_ACHIVED_NOT_FOUND, SUCCESS_SYNC_SALES_REPS_MONTHLY_TARGETS, TARGETS_ACHIEVED_DATA_FETCH_SUCCESS, SALES_REP_MONTHLY_WISE_FACILITIES_COUNT_FETCHED_SUCCESSFULLY,
    SUCCESS_FETCHED_STATS, SUCCESS_SALES_REPS_SYNC, SUCCESS_SYNCED_FACILICES
};
