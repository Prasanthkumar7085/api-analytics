...
const SUCCESS_FETCHED_SALES_REP_VOLUME_AND_REVENU = 'Sales Rep Case Types Volume And Revenue Data Fetched Successfully'
...
export {
    ...
    SUCCESS_FETCHED_SALES_REP_VOLUME_AND_REVENU, SUCCESS_FETCHED_CASE_TYPES_REVENUE, SUCCESS_FETCHED_FACILITY_CASE_TYPE_VOLUME_AND_REVENUE,
    ...
    SUCCESS_FETCHED_INSURANCE_STATS, SUCCESS_FETCHED_OVERVIEW_STATS_REVENUE, SUCCESS_FETCHED_OVERVIEW_STATS_VOLUME, SUCCES_FETCHED_OVERVIEW_CASE_TYPES,
    ...
    SUCCESS_FETECHED_INSURANCE_TRENDS_VOLUME, SUCCESS_FETCHED_INSURANCE_PAYORS_DETAILS
}
