...
export {
    ...
    SUCCESS_FETCHED_SALES_REP_TREND_VOLUME, SUCCESS_FETCHED_OVERVIEW_STATS_REVENUE, SUCCESS_FETCHED_OVERVIEW_STATS_VOLUME, SUCCES_FETCHED_OVERVIEW_CASE_TYPES,
    ...
    SUCCESS_FETECHED_INSURANCE_TRENDS_VOLUME, SUCCESS_DELETED_DATA_IN_TABLE, SUCCESS_FETCHED_PATIENT_CLAIMS_COUNT, SUCCESS_FETCHED_ONE_SALES_REP
}
