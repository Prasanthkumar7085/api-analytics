...
const SUCCESS_FETCHED_SALE_TREND_VOLUME = "Successfully fetched trends volume"
...
const SUCCESS_FETCHED_OVERVIEW_REVENUE = "Successfully Fetched Revenue Data"

const SUCCESS_FETCHED_FACILITIES_REVENUE_STATS = "successfully fetched facility stats revenue"
const SUCCESS_FETCHED_FACILITIES_VOLUME_STATS = "Successfully fetched facility stats volume"
const SUCCESSS_FETCHED_FACILITIES_CASES_TYPES_VOLUME = "Successfully fetched facility case types volume"

const SUCCESS_FETCHED_SALES_REP_COUNT_AND_VOLUME = 'Successfully fetched total count and volume of sales rep'
const SUCCESS_FETCHED_CASE_TYPES_REVENUE = 'Successfully fetched revenue for month wise case types'

const SUCCESS_FETCHED_CASE_TYPE_VOLUME_AND_COUNT = 'Successfully fetched total count and volume case types'
const SUCCESS_FETCHED_TREND_REVENUE = 'Successfully fetched trend revunue'
...
const SUCCESS_FETCHED_REVENUE_MONTH_WISE_TRENDS = 'Successfully fetched revenue data for month wise trends'
...
export {
    ...
    SUCCESS_FETCHED_SALES_REP_COUNT_AND_VOLUME, SUCCESS_FETCHED_CASE_TYPES_REVENUE, SUCCESS_FETCHED_CASE_TYPE_VOLUME_AND_COUNT,
    ...
    SUCCESSS_FETCHED_FACILITIES_CASES_TYPES_VOLUME, SUCCESS_FETCHED_REVENUE_MONTH_WISE_TRENDS
}
