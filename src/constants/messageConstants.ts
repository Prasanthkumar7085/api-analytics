...
const SUCCESS_FETECHED_FACILITIES_REVENUE_STATS="successfully fetched stats revenue"
...
export {
    ...
    SUCCESS_FETCHED_OVERVIEW_VOLUME_STATS, SUCCESS_FETCHED_OVERVIEW_REVENUE,SUCCESS_FETECHED_FACILITIES_REVENUE_STATS
}
